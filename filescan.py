...
offices = ["SSC"]
disciplines = ["CVL"]
days_threshold = 18 # The script will check for files modified up to this many days in the past. 
ind_projects_to_scan = {"SSC": [], "SYD": ["27868", "24234"]}  # This can be used to specify individual projects to scan, if needed.
